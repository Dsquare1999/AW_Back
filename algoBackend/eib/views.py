...
from .serializers import EIBSerializer,EIBCreateSerializer

import math
from datetime import datetime, timedelta
from dateutil.relativedelta import relativedelta

class EIBViewset(viewsets.ModelViewSet):
    queryset = EIB.objects.all()
    serializer_class = EIBSerializer

    def get_serializer_class(self):
        return EIBCreateSerializer if self.action == 'create' else EIBSerializer
    
    def perform_create(self, serializer):
        data = serializer.validated_data

        outstanding = data['eib_outstanding']
        value_date = data['eib_value_date']
        due_date = data['eib_due_date']
        taux_interet = data['eib_rate']
        ...
        serializer.save(
            eib_interest=interest,
            eib_cashflows=cashflows
        )